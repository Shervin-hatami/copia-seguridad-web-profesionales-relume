          ...
          fields: [
            {
              name: 'layout',
              type: 'blocks',
              blocks: [Banner1Block, CallToAction, Content, Footer1Block, Footer5Block, Header44Block, Header48Block, Layout1Block, MediaBlock, Archive, FormBlock, MultiForm1Block, Navbar1Block, Navbar5Block],
              required: true,
              admin: {
                initCollapsed: true,
              },
