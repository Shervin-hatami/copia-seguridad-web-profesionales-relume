...
export const enum_pages_blocks_banner1_button_size = pgEnum(
  'enum_pages_blocks_banner1_button_size',
  ['sm', 'md', 'lg'],
)
export const enum_pages_blocks_banner1_button_variant = pgEnum(
  'enum_pages_blocks_banner1_button_variant',
...
export const enum_pages_blocks_footer1_column_links_links_link_type = pgEnum(
  'enum_pages_blocks_footer1_column_links_links_link_type',
  ['reference', 'custom'],
)
export const enum_pages_blocks_footer1_column_links_links_icon = pgEnum(
  'enum_pages_blocks_footer1_column_links_links_icon',
  ['facebook', 'instagram', 'x', 'linkedin', 'youtube'],
)
export const enum_pages_blocks_footer1_footer_links_link_type = pgEnum(
  'enum_pages_blocks_footer1_footer_links_link_type',
  ['reference', 'custom'],
)
export const enum_pages_blocks_footer1_logo_link_type = pgEnum(
  'enum_pages_blocks_footer1_logo_link_type',
  ['reference', 'custom'],
)
export const enum_pages_blocks_footer1_button_size = pgEnum(
  'enum_pages_blocks_footer1_button_size',
  ['sm', 'md', 'lg'],
)
export const enum_pages_blocks_footer1_button_variant = pgEnum(
  'enum_pages_blocks_footer1_button_variant',
  ['default', 'destructive', 'outline', 'secondary', 'ghost', 'link'],
)
...
export const enum_pages_blocks_multi_form1_nav_button_variant = pgEnum(
  'enum_pages_blocks_multi_form1_nav_button_variant',
  ['primary', 'secondary', 'link'],
)
export const enum_pages_blocks_multi_form1_nav_button_size = pgEnum(
  'enum_pages_blocks_multi_form1_nav_button_size',
  ['default', 'sm', 'lg', 'link'],
)
export const enum_sub_links_link_type = pgEnum('enum_sub_links_link_type', ['reference', 'custom'])
export const enum_nav_links_link_type = pgEnum('enum_nav_links_link_type', ['reference', 'custom'])
export const enum_btns_link_type = pgEnum('enum_btns_link_type', ['reference', 'custom'])
export const enum_btns_size = pgEnum('enum_btns_size', ['sm', 'lg'])
export const enum_btns_variant = pgEnum('enum_btns_variant', [
  'default',
  'secondary',
  'ghost',
  'link',
])
export const enum_cat_link_items_5_link_type = pgEnum('enum_cat_link_items_5_link_type', [
  'reference',
  'custom',
])
export const enum_cat_link_items_5_button_size = pgEnum('enum_cat_link_items_5_button_size', [
  'sm',
  'lg',
])
export const enum_cat_link_items_5_button_variant = pgEnum('enum_cat_link_items_5_button_variant', [
  'default',
  'secondary',
  'ghost',
  'link',
])
export const enum_featured_links_5_link_type = pgEnum('enum_featured_links_5_link_type', [
  'reference',
  'custom',
])
export const enum_featured_links_5_button_size = pgEnum('enum_featured_links_5_button_size', [
  'sm',
  'lg',
])
export const enum_featured_links_5_button_variant = pgEnum('enum_featured_links_5_button_variant', [
  'default',
  'secondary',
  'ghost',
  'link',
])
export const enum_nav_links_5_link_type = pgEnum('enum_nav_links_5_link_type', [
  'reference',
  'custom',
])
export const enum_nav_links_5_mega_menu_button_size = pgEnum(
  'enum_nav_links_5_mega_menu_button_size',
  ['sm', 'lg'],
)
export const enum_nav_links_5_mega_menu_button_variant = pgEnum(
  'enum_nav_links_5_mega_menu_button_variant',
  ['default', 'secondary', 'ghost', 'link'],
)
export const enum_nav_links_5_mega_menu_button_link_type = pgEnum(
  'enum_nav_links_5_mega_menu_button_link_type',
  ['reference', 'custom'],
)
export const enum_btns_5_size = pgEnum('enum_btns_5_size', ['sm', 'lg'])
export const enum_btns_5_variant = pgEnum('enum_btns_5_variant', [
  'default',
  'secondary',
  'ghost',
  'link',
])
export const enum_btns_5_link_type = pgEnum('enum_btns_5_link_type', ['reference', 'custom'])
...
export const enum__pages_v_blocks_banner1_button_size = pgEnum(
  'enum__pages_v_blocks_banner1_button_size',
  ['sm', 'md', 'lg'],
)
export const enum__pages_v_blocks_banner1_button_variant = pgEnum(
  'enum__pages_v_blocks_banner1_button_variant',
  ['default', 'destructive', 'outline', 'secondary', 'ghost', 'link'],
)
...
export const enum__pages_v_blocks_footer1_column_links_links_link_type = pgEnum(
  'enum__pages_v_blocks_footer1_column_links_links_link_type',
  ['reference', 'custom'],
)
export const enum__pages_v_blocks_footer1_column_links_links_icon = pgEnum(
  'enum__pages_v_blocks_footer1_column_links_links_icon',
  ['facebook', 'instagram', 'x', 'linkedin', 'youtube'],
)
export const enum__pages_v_blocks_footer1_footer_links_link_type = pgEnum(
  'enum__pages_v_blocks_footer1_footer_links_link_type',
  ['reference', 'custom'],
)
export const enum__pages_v_blocks_footer1_logo_link_type = pgEnum(
  'enum__pages_v_blocks_footer1_logo_link_type',
  ['reference', 'custom'],
)
export const enum__pages_v_blocks_footer1_button_size = pgEnum(
  'enum__pages_v_blocks_footer1_button_size',
  ['sm', 'md', 'lg'],
)
export const enum__pages_v_blocks_footer1_button_variant = pgEnum(
  'enum__pages_v_blocks_footer1_button_variant',
  ['default', 'destructive', 'outline', 'secondary', 'ghost', 'link'],
)
...
export const enum__pages_v_blocks_multi_form1_nav_button_variant = pgEnum(
  'enum__pages_v_blocks_multi_form1_nav_button_variant',
  ['primary', 'secondary', 'link'],
)
export const enum__pages_v_blocks_multi_form1_nav_button_size = pgEnum(
  'enum__pages_v_blocks_multi_form1_nav_button_size',
  ['default', 'sm', 'lg', 'link'],
)
export const enum__sub_links_v_link_type = pgEnum('enum__sub_links_v_link_type', [
  'reference',
  'custom',
])
export const enum__nav_links_v_link_type = pgEnum('enum__nav_links_v_link_type', [
  'reference',
  'custom',
])
export const enum__btns_v_link_type = pgEnum('enum__btns_v_link_type', ['reference', 'custom'])
export const enum__btns_v_size = pgEnum('enum__btns_v_size', ['sm', 'lg'])
export const enum__btns_v_variant = pgEnum('enum__btns_v_variant', [
  'default',
  'secondary',
  'ghost',
  'link',
])
export const enum__cat_link_items_5_v_link_type = pgEnum('enum__cat_link_items_5_v_link_type', [
  'reference',
  'custom',
])
export const enum__cat_link_items_5_v_button_size = pgEnum('enum__cat_link_items_5_v_button_size', [
  'sm',
  'lg',
])
export const enum__cat_link_items_5_v_button_variant = pgEnum(
  'enum__cat_link_items_5_v_button_variant',
  ['default', 'secondary', 'ghost', 'link'],
)
export const enum__featured_links_5_v_link_type = pgEnum('enum__featured_links_5_v_link_type', [
  'reference',
  'custom',
])
export const enum__featured_links_5_v_button_size = pgEnum('enum__featured_links_5_v_button_size', [
  'sm',
  'lg',
])
export const enum__featured_links_5_v_button_variant = pgEnum(
  'enum__featured_links_5_v_button_variant',
  ['default', 'secondary', 'ghost', 'link'],
)
export const enum__nav_links_5_v_link_type = pgEnum('enum__nav_links_5_v_link_type', [
  'reference',
  'custom',
])
export const enum__nav_links_5_v_mega_menu_button_size = pgEnum(
  'enum__nav_links_5_v_mega_menu_button_size',
  ['sm', 'lg'],
)
export const enum__nav_links_5_v_mega_menu_button_variant = pgEnum(
  'enum__nav_links_5_v_mega_menu_button_variant',
  ['default', 'secondary', 'ghost', 'link'],
)
export const enum__nav_links_5_v_mega_menu_button_link_type = pgEnum(
  'enum__nav_links_5_v_mega_menu_button_link_type',
  ['reference', 'custom'],
)
export const enum__btns_5_v_size = pgEnum('enum__btns_5_v_size', ['sm', 'lg'])
export const enum__btns_5_v_variant = pgEnum('enum__btns_5_v_variant', [
  'default',
  'secondary',
  'ghost',
  'link',
])
export const enum__btns_5_v_link_type = pgEnum('enum__btns_5_v_link_type', ['reference', 'custom'])
...
export const pages_blocks_banner1 = pgTable(
  'pages_blocks_banner1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    heading: varchar('heading').default('Medium length banner heading goes here'),
    description: varchar('description').default(
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    ),
    logo_url: varchar('logo_url').default('#'),
    logo_src: varchar('logo_src').default('https://d22po4pjz3o32e.cloudfront.net/relume-icon.svg'),
    logo_alt: varchar('logo_alt').default('Relume logo'),
    inputPlaceholder: varchar('input_placeholder').default('Enter your email'),
    button_title: varchar('button_title').default('Sign up'),
    button_size: enum_pages_blocks_banner1_button_size('button_size').default('sm'),
    button_variant: enum_pages_blocks_banner1_button_variant('button_variant').default('default'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_banner1_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_banner1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_banner1_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_banner1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_footer1_column_links_links = pgTable(
  'pages_blocks_footer1_column_links_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    link_type:
      enum_pages_blocks_footer1_column_links_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    icon: enum_pages_blocks_footer1_column_links_links_icon('icon'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_footer1_column_links_links_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_footer1_column_links_links_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_footer1_column_links.id],
      name: 'pages_blocks_footer1_column_links_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_footer1_column_links = pgTable(
  'pages_blocks_footer1_column_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_footer1_column_links_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_footer1_column_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_footer1.id],
      name: 'pages_blocks_footer1_column_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_footer1_footer_links = pgTable(
  'pages_blocks_footer1_footer_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    link_type: enum_pages_blocks_footer1_footer_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_footer1_footer_links_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_footer1_footer_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_footer1.id],
      name: 'pages_blocks_footer1_footer_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_footer1 = pgTable(
  'pages_blocks_footer1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    logo_media: integer('logo_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    logo_link_type: enum_pages_blocks_footer1_logo_link_type('logo_link_type').default('reference'),
    logo_link_newTab: boolean('logo_link_new_tab'),
    logo_link_url: varchar('logo_link_url'),
    newsletterDescription: varchar('newsletter_description').default(
      'Join our newsletter to stay up to date on features and releases.',
    ),
    inputPlaceholder: varchar('input_placeholder').default('Enter your email'),
    button_title: varchar('button_title').default('Subscribe'),
    button_size: enum_pages_blocks_footer1_button_size('button_size').default('sm'),
    button_variant: enum_pages_blocks_footer1_button_variant('button_variant').default('secondary'),
    termsAndConditions: jsonb('terms_and_conditions').default(
      sql`'[{"children":[{"text":"By subscribing you agree to with our "},{"children":[{"text":"Privacy Policy"}],"type":"link","url":"#"},{"text":" and provide consent to receive updates from our company."}],"type":"p"}]'::jsonb`,
    ),
    footerText: varchar('footer_text').default('© 2024 Relume. All rights reserved.'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_footer1_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_footer1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_footer1_path_idx').on(columns._path),
    pages_blocks_footer1_logo_logo_media_idx: index('pages_blocks_footer1_logo_logo_media_idx').on(
      columns.logo_media,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_footer1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_multi_form1 = pgTable(
  'pages_blocks_multi_form1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    ...
    logo_src: varchar('logo_src'),
    logo_alt: varchar('logo_alt'),
    navText: varchar('nav_text'),
    navButton_title: varchar('nav_button_title'),
    navButton_variant: enum_pages_blocks_multi_form1_nav_button_variant('nav_button_variant'),
    navButton_size: enum_pages_blocks_multi_form1_nav_button_size('nav_button_size'),
    footerText: varchar('footer_text'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_multi_form1_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_multi_form1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_multi_form1_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_multi_form1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const sub_links = pgTable(
  'sub_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    link_type: enum_sub_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  },
  (columns) => ({
    _orderIdx: index('sub_links_order_idx').on(columns._order),
    _parentIDIdx: index('sub_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [nav_links.id],
      name: 'sub_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const nav_links = pgTable(
  'nav_links',
  {
    ...
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    link_type: enum_nav_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  },
  (columns) => ({
    _orderIdx: index('nav_links_order_idx').on(columns._order),
    _parentIDIdx: index('nav_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_navbar1.id],
      name: 'nav_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const btns = pgTable(
  'btns',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    link_type: enum_btns_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    size: enum_btns_size('size').default('sm'),
    variant: enum_btns_variant('variant').default('default'),
  },
  (columns) => ({
    _orderIdx: index('btns_order_idx').on(columns._order),
    _parentIDIdx: index('btns_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_navbar1.id],
      name: 'btns_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_navbar1 = pgTable(
  'pages_blocks_navbar1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    logo_useMedia: boolean('logo_use_media').default(false),
    logo_media: integer('logo_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    logo_url: varchar('logo_url').default('#'),
    logo_src: varchar('logo_src').default('https://d22po4pjz3o32e.cloudfront.net/logo-image.svg'),
    logo_alt: varchar('logo_alt').default('Logo image'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_navbar1_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_navbar1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_navbar1_path_idx').on(columns._path),
    pages_blocks_navbar1_logo_logo_media_idx: index('pages_blocks_navbar1_logo_logo_media_idx').on(
      columns.logo_media,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_navbar1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const cat_link_items_5 = pgTable(
  'cat_link_items_5',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_cat_link_items_5_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    image_src: varchar('image_src'),
    image_alt: varchar('image_alt'),
    title: varchar('title'),
    description: varchar('description'),
    button_title: varchar('button_title'),
    button_size: enum_cat_link_items_5_button_size('button_size').default('sm'),
    button_variant: enum_cat_link_items_5_button_variant('button_variant').default('default'),
  },
  (columns) => ({
    _orderIdx: index('cat_link_items_5_order_idx').on(columns._order),
    _parentIDIdx: index('cat_link_items_5_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [cat_links_5.id],
      name: 'cat_link_items_5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const cat_links_5 = pgTable(
  'cat_links_5',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('cat_links_5_order_idx').on(columns._order),
    _parentIDIdx: index('cat_links_5_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [nav_links_5.id],
      name: 'cat_links_5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const featured_links_5 = pgTable(
  'featured_links_5',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_featured_links_5_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    image_src: varchar('image_src'),
    image_alt: varchar('image_alt'),
    ...
    description: varchar('description'),
    button_title: varchar('button_title'),
    button_size: enum_featured_links_5_button_size('button_size').default('sm'),
    button_variant: enum_featured_links_5_button_variant('button_variant').default('default'),
  },
  (columns) => ({
    _orderIdx: index('featured_links_5_order_idx').on(columns._order),
    _parentIDIdx: index('featured_links_5_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [nav_links_5.id],
      name: 'featured_links_5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const nav_links_5 = pgTable(
  'nav_links_5',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    link_type: enum_nav_links_5_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    megaMenu_featuredSections_title: varchar('mega_menu_featured_sections_title'),
    megaMenu_button_title: varchar('mega_menu_button_title'),
    megaMenu_button_size:
      enum_nav_links_5_mega_menu_button_size('mega_menu_button_size').default('sm'),
    megaMenu_button_variant: enum_nav_links_5_mega_menu_button_variant(
      'mega_menu_button_variant',
    ).default('default'),
    megaMenu_button_link_type: enum_nav_links_5_mega_menu_button_link_type(
      'mega_menu_button_link_type',
    ).default('reference'),
    megaMenu_button_link_newTab: boolean('mega_menu_button_link_new_tab'),
    megaMenu_button_link_url: varchar('mega_menu_button_link_url'),
  },
  (columns) => ({
    _orderIdx: index('nav_links_5_order_idx').on(columns._order),
    _parentIDIdx: index('nav_links_5_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_navbar5.id],
      name: 'nav_links_5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const btns_5 = pgTable(
  'btns_5',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    title: varchar('title'),
    size: enum_btns_5_size('size').default('sm'),
    variant: enum_btns_5_variant('variant').default('default'),
    link_type: enum_btns_5_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
  },
  (columns) => ({
    _orderIdx: index('btns_5_order_idx').on(columns._order),
    _parentIDIdx: index('btns_5_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_navbar5.id],
      name: 'btns_5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_navbar5 = pgTable(
  'pages_blocks_navbar5',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_navbar5_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_navbar5_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_navbar5_path_idx').on(columns._path),
    pages_blocks_navbar5_logo_logo_media_idx: index('pages_blocks_navbar5_logo_logo_media_idx').on(
      columns.logo_media,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_navbar5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_banner1 = pgTable(
  '_pages_v_blocks_banner1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    ...
    inputPlaceholder: varchar('input_placeholder').default('Enter your email'),
    button_title: varchar('button_title').default('Sign up'),
    button_size: enum__pages_v_blocks_banner1_button_size('button_size').default('sm'),
    button_variant:
      enum__pages_v_blocks_banner1_button_variant('button_variant').default('default'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_banner1_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_banner1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_banner1_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_banner1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_footer1_column_links_links = pgTable(
  '_pages_v_blocks_footer1_column_links_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    link_type:
      enum__pages_v_blocks_footer1_column_links_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    icon: enum__pages_v_blocks_footer1_column_links_links_icon('icon'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_footer1_column_links_links_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_footer1_column_links_links_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_footer1_column_links.id],
      name: '_pages_v_blocks_footer1_column_links_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_footer1_column_links = pgTable(
  '_pages_v_blocks_footer1_column_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_footer1_column_links_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_footer1_column_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_footer1.id],
      name: '_pages_v_blocks_footer1_column_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_footer1_footer_links = pgTable(
  '_pages_v_blocks_footer1_footer_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    link_type:
      enum__pages_v_blocks_footer1_footer_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_footer1_footer_links_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_footer1_footer_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_footer1.id],
      name: '_pages_v_blocks_footer1_footer_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_footer1 = pgTable(
  '_pages_v_blocks_footer1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    ...
    logo_link_type:
      enum__pages_v_blocks_footer1_logo_link_type('logo_link_type').default('reference'),
    logo_link_newTab: boolean('logo_link_new_tab'),
    logo_link_url: varchar('logo_link_url'),
    newsletterDescription: varchar('newsletter_description').default(
      'Join our newsletter to stay up to date on features and releases.',
    ...
    inputPlaceholder: varchar('input_placeholder').default('Enter your email'),
    button_title: varchar('button_title').default('Subscribe'),
    button_size: enum__pages_v_blocks_footer1_button_size('button_size').default('sm'),
    button_variant:
      enum__pages_v_blocks_footer1_button_variant('button_variant').default('secondary'),
    termsAndConditions: jsonb('terms_and_conditions').default(
      sql`'[{"children":[{"text":"By subscribing you agree to with our "},{"children":[{"text":"Privacy Policy"}],"type":"link","url":"#"},{"text":" and provide consent to receive updates from our company."}],"type":"p"}]'::jsonb`,
    ),
    footerText: varchar('footer_text').default('© 2024 Relume. All rights reserved.'),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_footer1_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_footer1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_footer1_path_idx').on(columns._path),
    _pages_v_blocks_footer1_logo_logo_media_idx: index(
      '_pages_v_blocks_footer1_logo_logo_media_idx',
    ).on(columns.logo_media),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_footer1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_multi_form1 = pgTable(
  '_pages_v_blocks_multi_form1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    ...
    navText: varchar('nav_text'),
    navButton_title: varchar('nav_button_title'),
    navButton_variant: enum__pages_v_blocks_multi_form1_nav_button_variant('nav_button_variant'),
    navButton_size: enum__pages_v_blocks_multi_form1_nav_button_size('nav_button_size'),
    footerText: varchar('footer_text'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_multi_form1_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_multi_form1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_multi_form1_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_multi_form1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _sub_links_v = pgTable(
  '_sub_links_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    link_type: enum__sub_links_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_sub_links_v_order_idx').on(columns._order),
    _parentIDIdx: index('_sub_links_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_nav_links_v.id],
      name: '_sub_links_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _nav_links_v = pgTable(
  '_nav_links_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    link_type: enum__nav_links_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_nav_links_v_order_idx').on(columns._order),
    _parentIDIdx: index('_nav_links_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_navbar1.id],
      name: '_nav_links_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _btns_v = pgTable(
  '_btns_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    link_type: enum__btns_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    size: enum__btns_v_size('size').default('sm'),
    variant: enum__btns_v_variant('variant').default('default'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_btns_v_order_idx').on(columns._order),
    _parentIDIdx: index('_btns_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_navbar1.id],
      name: '_btns_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_navbar1 = pgTable(
  '_pages_v_blocks_navbar1',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_navbar1_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_navbar1_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_navbar1_path_idx').on(columns._path),
    _pages_v_blocks_navbar1_logo_logo_media_idx: index(
      '_pages_v_blocks_navbar1_logo_logo_media_idx',
    ).on(columns.logo_media),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_navbar1_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _cat_link_items_5_v = pgTable(
  '_cat_link_items_5_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    link_type: enum__cat_link_items_5_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    image_src: varchar('image_src'),
    image_alt: varchar('image_alt'),
    ...
    description: varchar('description'),
    button_title: varchar('button_title'),
    button_size: enum__cat_link_items_5_v_button_size('button_size').default('sm'),
    button_variant: enum__cat_link_items_5_v_button_variant('button_variant').default('default'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_cat_link_items_5_v_order_idx').on(columns._order),
    _parentIDIdx: index('_cat_link_items_5_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_cat_links_5_v.id],
      name: '_cat_link_items_5_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _cat_links_5_v = pgTable(
  '_cat_links_5_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_cat_links_5_v_order_idx').on(columns._order),
    _parentIDIdx: index('_cat_links_5_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_nav_links_5_v.id],
      name: '_cat_links_5_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _featured_links_5_v = pgTable(
  '_featured_links_5_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    link_type: enum__featured_links_5_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    image_src: varchar('image_src'),
    image_alt: varchar('image_alt'),
    ...
    description: varchar('description'),
    button_title: varchar('button_title'),
    button_size: enum__featured_links_5_v_button_size('button_size').default('sm'),
    button_variant: enum__featured_links_5_v_button_variant('button_variant').default('default'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_featured_links_5_v_order_idx').on(columns._order),
    _parentIDIdx: index('_featured_links_5_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_nav_links_5_v.id],
      name: '_featured_links_5_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _nav_links_5_v = pgTable(
  '_nav_links_5_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    link_type: enum__nav_links_5_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    megaMenu_featuredSections_title: varchar('mega_menu_featured_sections_title'),
    megaMenu_button_title: varchar('mega_menu_button_title'),
    megaMenu_button_size:
      enum__nav_links_5_v_mega_menu_button_size('mega_menu_button_size').default('sm'),
    megaMenu_button_variant: enum__nav_links_5_v_mega_menu_button_variant(
      'mega_menu_button_variant',
    ).default('default'),
    megaMenu_button_link_type: enum__nav_links_5_v_mega_menu_button_link_type(
      'mega_menu_button_link_type',
    ).default('reference'),
    megaMenu_button_link_newTab: boolean('mega_menu_button_link_new_tab'),
    megaMenu_button_link_url: varchar('mega_menu_button_link_url'),
  ...
  (columns) => ({
    _orderIdx: index('_nav_links_5_v_order_idx').on(columns._order),
    _parentIDIdx: index('_nav_links_5_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_navbar5.id],
      name: '_nav_links_5_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _btns_5_v = pgTable(
  '_btns_5_v',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    title: varchar('title'),
    size: enum__btns_5_v_size('size').default('sm'),
    variant: enum__btns_5_v_variant('variant').default('default'),
    link_type: enum__btns_5_v_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_btns_5_v_order_idx').on(columns._order),
    _parentIDIdx: index('_btns_5_v_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_navbar5.id],
      name: '_btns_5_v_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_navbar5 = pgTable(
  '_pages_v_blocks_navbar5',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_navbar5_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_navbar5_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_navbar5_path_idx').on(columns._path),
    _pages_v_blocks_navbar5_logo_logo_media_idx: index(
      '_pages_v_blocks_navbar5_logo_logo_media_idx',
    ).on(columns.logo_media),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_navbar5_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const relations_pages_blocks_banner1 = relations(pages_blocks_banner1, ({ one }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_banner1._parentID],
    references: [pages.id],
    relationName: '_blocks_banner1',
  }),
}))
...
export const relations_pages_blocks_footer1_column_links_links = relations(
  pages_blocks_footer1_column_links_links,
  ({ one }) => ({
    _parentID: one(pages_blocks_footer1_column_links, {
      fields: [pages_blocks_footer1_column_links_links._parentID],
      references: [pages_blocks_footer1_column_links.id],
      relationName: 'links',
    }),
  }),
)
export const relations_pages_blocks_footer1_column_links = relations(
  pages_blocks_footer1_column_links,
  ({ one, many }) => ({
    _parentID: one(pages_blocks_footer1, {
      fields: [pages_blocks_footer1_column_links._parentID],
      references: [pages_blocks_footer1.id],
      relationName: 'columnLinks',
    }),
    links: many(pages_blocks_footer1_column_links_links, {
      relationName: 'links',
    }),
  }),
)
export const relations_pages_blocks_footer1_footer_links = relations(
  pages_blocks_footer1_footer_links,
  ({ one }) => ({
    _parentID: one(pages_blocks_footer1, {
      fields: [pages_blocks_footer1_footer_links._parentID],
      references: [pages_blocks_footer1.id],
      relationName: 'footerLinks',
    }),
  }),
)
export const relations_pages_blocks_footer1 = relations(pages_blocks_footer1, ({ one, many }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_footer1._parentID],
    references: [pages.id],
    relationName: '_blocks_footer1',
  }),
  logo_media: one(media, {
    fields: [pages_blocks_footer1.logo_media],
    references: [media.id],
    relationName: 'logo_media',
  }),
  columnLinks: many(pages_blocks_footer1_column_links, {
    relationName: 'columnLinks',
  }),
  footerLinks: many(pages_blocks_footer1_footer_links, {
    relationName: 'footerLinks',
  }),
}))
...
export const relations_pages_blocks_multi_form1 = relations(
  pages_blocks_multi_form1,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_multi_form1._parentID],
      references: [pages.id],
      relationName: '_blocks_multiForm1',
    }),
  }),
)
export const relations_sub_links = relations(sub_links, ({ one }) => ({
  _parentID: one(nav_links, {
    fields: [sub_links._parentID],
    references: [nav_links.id],
    relationName: 'subMenuLinks',
  }),
}))
export const relations_nav_links = relations(nav_links, ({ one, many }) => ({
  _parentID: one(pages_blocks_navbar1, {
    fields: [nav_links._parentID],
    references: [pages_blocks_navbar1.id],
    relationName: 'navLinks',
  }),
  subMenuLinks: many(sub_links, {
    relationName: 'subMenuLinks',
  }),
}))
export const relations_btns = relations(btns, ({ one }) => ({
  _parentID: one(pages_blocks_navbar1, {
    fields: [btns._parentID],
    references: [pages_blocks_navbar1.id],
    relationName: 'buttons',
  }),
}))
export const relations_pages_blocks_navbar1 = relations(pages_blocks_navbar1, ({ one, many }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_navbar1._parentID],
    references: [pages.id],
    relationName: '_blocks_navbar1',
  }),
  logo_media: one(media, {
    fields: [pages_blocks_navbar1.logo_media],
    references: [media.id],
    relationName: 'logo_media',
  }),
  navLinks: many(nav_links, {
    relationName: 'navLinks',
  }),
  buttons: many(btns, {
    relationName: 'buttons',
...
export const relations_cat_link_items_5 = relations(cat_link_items_5, ({ one }) => ({
  _parentID: one(cat_links_5, {
    fields: [cat_link_items_5._parentID],
    references: [cat_links_5.id],
    relationName: 'links',
  }),
}))
export const relations_cat_links_5 = relations(cat_links_5, ({ one, many }) => ({
  _parentID: one(nav_links_5, {
    fields: [cat_links_5._parentID],
    references: [nav_links_5.id],
    relationName: 'megaMenu_categoryLinks',
  }),
  links: many(cat_link_items_5, {
    relationName: 'links',
  }),
}))
export const relations_featured_links_5 = relations(featured_links_5, ({ one }) => ({
  _parentID: one(nav_links_5, {
    fields: [featured_links_5._parentID],
    references: [nav_links_5.id],
    relationName: 'megaMenu_featuredSections_links',
  }),
}))
export const relations_nav_links_5 = relations(nav_links_5, ({ one, many }) => ({
  _parentID: one(pages_blocks_navbar5, {
    fields: [nav_links_5._parentID],
    references: [pages_blocks_navbar5.id],
    relationName: 'links',
  }),
  megaMenu_categoryLinks: many(cat_links_5, {
    relationName: 'megaMenu_categoryLinks',
  }),
  megaMenu_featuredSections_links: many(featured_links_5, {
    relationName: 'megaMenu_featuredSections_links',
  }),
}))
export const relations_btns_5 = relations(btns_5, ({ one }) => ({
  _parentID: one(pages_blocks_navbar5, {
    fields: [btns_5._parentID],
    references: [pages_blocks_navbar5.id],
    relationName: 'buttons',
  }),
}))
export const relations_pages_blocks_navbar5 = relations(pages_blocks_navbar5, ({ one, many }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_navbar5._parentID],
    references: [pages.id],
    relationName: '_blocks_navbar5',
  }),
  logo_media: one(media, {
    fields: [pages_blocks_navbar5.logo_media],
    references: [media.id],
    relationName: 'logo_media',
  }),
  links: many(nav_links_5, {
    relationName: 'links',
  }),
  buttons: many(btns_5, {
    relationName: 'buttons',
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_banner1: many(pages_blocks_banner1, {
    relationName: '_blocks_banner1',
  }),
  ...
  _blocks_footer1: many(pages_blocks_footer1, {
    relationName: '_blocks_footer1',
  }),
  ...
  _blocks_multiForm1: many(pages_blocks_multi_form1, {
    relationName: '_blocks_multiForm1',
  }),
  _blocks_navbar1: many(pages_blocks_navbar1, {
    relationName: '_blocks_navbar1',
  }),
  _blocks_navbar5: many(pages_blocks_navbar5, {
    relationName: '_blocks_navbar5',
  }),
...
export const relations__pages_v_blocks_banner1 = relations(_pages_v_blocks_banner1, ({ one }) => ({
  _parentID: one(_pages_v, {
    fields: [_pages_v_blocks_banner1._parentID],
    references: [_pages_v.id],
    relationName: '_blocks_banner1',
  }),
}))
...
export const relations__pages_v_blocks_footer1_column_links_links = relations(
  _pages_v_blocks_footer1_column_links_links,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_footer1_column_links, {
      fields: [_pages_v_blocks_footer1_column_links_links._parentID],
      references: [_pages_v_blocks_footer1_column_links.id],
      relationName: 'links',
    }),
  }),
)
export const relations__pages_v_blocks_footer1_column_links = relations(
  _pages_v_blocks_footer1_column_links,
  ({ one, many }) => ({
    _parentID: one(_pages_v_blocks_footer1, {
      fields: [_pages_v_blocks_footer1_column_links._parentID],
      references: [_pages_v_blocks_footer1.id],
      relationName: 'columnLinks',
    }),
    links: many(_pages_v_blocks_footer1_column_links_links, {
      relationName: 'links',
    }),
  }),
)
export const relations__pages_v_blocks_footer1_footer_links = relations(
  _pages_v_blocks_footer1_footer_links,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_footer1, {
      fields: [_pages_v_blocks_footer1_footer_links._parentID],
      references: [_pages_v_blocks_footer1.id],
      relationName: 'footerLinks',
    }),
  }),
)
export const relations__pages_v_blocks_footer1 = relations(
  _pages_v_blocks_footer1,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_footer1._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_footer1',
    }),
    logo_media: one(media, {
      fields: [_pages_v_blocks_footer1.logo_media],
      references: [media.id],
      relationName: 'logo_media',
    }),
    columnLinks: many(_pages_v_blocks_footer1_column_links, {
      relationName: 'columnLinks',
    }),
    footerLinks: many(_pages_v_blocks_footer1_footer_links, {
      relationName: 'footerLinks',
    }),
  }),
)
...
export const relations__pages_v_blocks_multi_form1 = relations(
  _pages_v_blocks_multi_form1,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_multi_form1._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_multiForm1',
    }),
  }),
)
export const relations__sub_links_v = relations(_sub_links_v, ({ one }) => ({
  _parentID: one(_nav_links_v, {
    fields: [_sub_links_v._parentID],
    references: [_nav_links_v.id],
    relationName: 'subMenuLinks',
  }),
}))
export const relations__nav_links_v = relations(_nav_links_v, ({ one, many }) => ({
  _parentID: one(_pages_v_blocks_navbar1, {
    fields: [_nav_links_v._parentID],
    references: [_pages_v_blocks_navbar1.id],
    relationName: 'navLinks',
  }),
  subMenuLinks: many(_sub_links_v, {
    relationName: 'subMenuLinks',
  }),
}))
export const relations__btns_v = relations(_btns_v, ({ one }) => ({
  _parentID: one(_pages_v_blocks_navbar1, {
    fields: [_btns_v._parentID],
    references: [_pages_v_blocks_navbar1.id],
    relationName: 'buttons',
  }),
}))
export const relations__pages_v_blocks_navbar1 = relations(
  _pages_v_blocks_navbar1,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_navbar1._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_navbar1',
    }),
    logo_media: one(media, {
      fields: [_pages_v_blocks_navbar1.logo_media],
      references: [media.id],
      relationName: 'logo_media',
    }),
    navLinks: many(_nav_links_v, {
      relationName: 'navLinks',
    }),
    buttons: many(_btns_v, {
      relationName: 'buttons',
    }),
  }),
)
export const relations__cat_link_items_5_v = relations(_cat_link_items_5_v, ({ one }) => ({
  _parentID: one(_cat_links_5_v, {
    fields: [_cat_link_items_5_v._parentID],
    references: [_cat_links_5_v.id],
    relationName: 'links',
  }),
}))
export const relations__cat_links_5_v = relations(_cat_links_5_v, ({ one, many }) => ({
  _parentID: one(_nav_links_5_v, {
    fields: [_cat_links_5_v._parentID],
    references: [_nav_links_5_v.id],
    relationName: 'megaMenu_categoryLinks',
  }),
  links: many(_cat_link_items_5_v, {
    relationName: 'links',
  }),
}))
export const relations__featured_links_5_v = relations(_featured_links_5_v, ({ one }) => ({
  _parentID: one(_nav_links_5_v, {
    fields: [_featured_links_5_v._parentID],
    references: [_nav_links_5_v.id],
    relationName: 'megaMenu_featuredSections_links',
  }),
}))
export const relations__nav_links_5_v = relations(_nav_links_5_v, ({ one, many }) => ({
  _parentID: one(_pages_v_blocks_navbar5, {
    fields: [_nav_links_5_v._parentID],
    references: [_pages_v_blocks_navbar5.id],
    relationName: 'links',
  }),
  megaMenu_categoryLinks: many(_cat_links_5_v, {
    relationName: 'megaMenu_categoryLinks',
  }),
  megaMenu_featuredSections_links: many(_featured_links_5_v, {
    relationName: 'megaMenu_featuredSections_links',
  }),
}))
export const relations__btns_5_v = relations(_btns_5_v, ({ one }) => ({
  _parentID: one(_pages_v_blocks_navbar5, {
    fields: [_btns_5_v._parentID],
    references: [_pages_v_blocks_navbar5.id],
    relationName: 'buttons',
  }),
}))
export const relations__pages_v_blocks_navbar5 = relations(
  _pages_v_blocks_navbar5,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_navbar5._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_navbar5',
    }),
    logo_media: one(media, {
      fields: [_pages_v_blocks_navbar5.logo_media],
      references: [media.id],
      relationName: 'logo_media',
    }),
    links: many(_nav_links_5_v, {
      relationName: 'links',
    }),
    buttons: many(_btns_5_v, {
      relationName: 'buttons',
    }),
  }),
)
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_banner1: many(_pages_v_blocks_banner1, {
    relationName: '_blocks_banner1',
  }),
  ...
  _blocks_footer1: many(_pages_v_blocks_footer1, {
    relationName: '_blocks_footer1',
  }),
  ...
  _blocks_multiForm1: many(_pages_v_blocks_multi_form1, {
    relationName: '_blocks_multiForm1',
  }),
  _blocks_navbar1: many(_pages_v_blocks_navbar1, {
    relationName: '_blocks_navbar1',
  }),
  _blocks_navbar5: many(_pages_v_blocks_navbar5, {
    relationName: '_blocks_navbar5',
  }),
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_banner1_button_size: typeof enum_pages_blocks_banner1_button_size
  enum_pages_blocks_banner1_button_variant: typeof enum_pages_blocks_banner1_button_variant
  ...
  enum_pages_blocks_footer1_column_links_links_link_type: typeof enum_pages_blocks_footer1_column_links_links_link_type
  enum_pages_blocks_footer1_column_links_links_icon: typeof enum_pages_blocks_footer1_column_links_links_icon
  enum_pages_blocks_footer1_footer_links_link_type: typeof enum_pages_blocks_footer1_footer_links_link_type
  enum_pages_blocks_footer1_logo_link_type: typeof enum_pages_blocks_footer1_logo_link_type
  enum_pages_blocks_footer1_button_size: typeof enum_pages_blocks_footer1_button_size
  enum_pages_blocks_footer1_button_variant: typeof enum_pages_blocks_footer1_button_variant
  ...
  enum_pages_blocks_multi_form1_nav_button_variant: typeof enum_pages_blocks_multi_form1_nav_button_variant
  enum_pages_blocks_multi_form1_nav_button_size: typeof enum_pages_blocks_multi_form1_nav_button_size
  enum_sub_links_link_type: typeof enum_sub_links_link_type
  enum_nav_links_link_type: typeof enum_nav_links_link_type
  enum_btns_link_type: typeof enum_btns_link_type
  enum_btns_size: typeof enum_btns_size
  enum_btns_variant: typeof enum_btns_variant
  enum_cat_link_items_5_link_type: typeof enum_cat_link_items_5_link_type
  enum_cat_link_items_5_button_size: typeof enum_cat_link_items_5_button_size
  enum_cat_link_items_5_button_variant: typeof enum_cat_link_items_5_button_variant
  enum_featured_links_5_link_type: typeof enum_featured_links_5_link_type
  enum_featured_links_5_button_size: typeof enum_featured_links_5_button_size
  enum_featured_links_5_button_variant: typeof enum_featured_links_5_button_variant
  enum_nav_links_5_link_type: typeof enum_nav_links_5_link_type
  enum_nav_links_5_mega_menu_button_size: typeof enum_nav_links_5_mega_menu_button_size
  enum_nav_links_5_mega_menu_button_variant: typeof enum_nav_links_5_mega_menu_button_variant
  enum_nav_links_5_mega_menu_button_link_type: typeof enum_nav_links_5_mega_menu_button_link_type
  enum_btns_5_size: typeof enum_btns_5_size
  enum_btns_5_variant: typeof enum_btns_5_variant
  enum_btns_5_link_type: typeof enum_btns_5_link_type
  ...
  enum__pages_v_blocks_banner1_button_size: typeof enum__pages_v_blocks_banner1_button_size
  enum__pages_v_blocks_banner1_button_variant: typeof enum__pages_v_blocks_banner1_button_variant
  ...
  enum__pages_v_blocks_footer1_column_links_links_link_type: typeof enum__pages_v_blocks_footer1_column_links_links_link_type
  enum__pages_v_blocks_footer1_column_links_links_icon: typeof enum__pages_v_blocks_footer1_column_links_links_icon
  enum__pages_v_blocks_footer1_footer_links_link_type: typeof enum__pages_v_blocks_footer1_footer_links_link_type
  enum__pages_v_blocks_footer1_logo_link_type: typeof enum__pages_v_blocks_footer1_logo_link_type
  enum__pages_v_blocks_footer1_button_size: typeof enum__pages_v_blocks_footer1_button_size
  enum__pages_v_blocks_footer1_button_variant: typeof enum__pages_v_blocks_footer1_button_variant
  ...
  enum__pages_v_blocks_multi_form1_nav_button_variant: typeof enum__pages_v_blocks_multi_form1_nav_button_variant
  enum__pages_v_blocks_multi_form1_nav_button_size: typeof enum__pages_v_blocks_multi_form1_nav_button_size
  enum__sub_links_v_link_type: typeof enum__sub_links_v_link_type
  enum__nav_links_v_link_type: typeof enum__nav_links_v_link_type
  enum__btns_v_link_type: typeof enum__btns_v_link_type
  enum__btns_v_size: typeof enum__btns_v_size
  enum__btns_v_variant: typeof enum__btns_v_variant
  enum__cat_link_items_5_v_link_type: typeof enum__cat_link_items_5_v_link_type
  enum__cat_link_items_5_v_button_size: typeof enum__cat_link_items_5_v_button_size
  enum__cat_link_items_5_v_button_variant: typeof enum__cat_link_items_5_v_button_variant
  enum__featured_links_5_v_link_type: typeof enum__featured_links_5_v_link_type
  enum__featured_links_5_v_button_size: typeof enum__featured_links_5_v_button_size
  enum__featured_links_5_v_button_variant: typeof enum__featured_links_5_v_button_variant
  enum__nav_links_5_v_link_type: typeof enum__nav_links_5_v_link_type
  enum__nav_links_5_v_mega_menu_button_size: typeof enum__nav_links_5_v_mega_menu_button_size
  enum__nav_links_5_v_mega_menu_button_variant: typeof enum__nav_links_5_v_mega_menu_button_variant
  enum__nav_links_5_v_mega_menu_button_link_type: typeof enum__nav_links_5_v_mega_menu_button_link_type
  enum__btns_5_v_size: typeof enum__btns_5_v_size
  enum__btns_5_v_variant: typeof enum__btns_5_v_variant
  enum__btns_5_v_link_type: typeof enum__btns_5_v_link_type
  ...
  pages_blocks_banner1: typeof pages_blocks_banner1
  ...
  pages_blocks_footer1_column_links_links: typeof pages_blocks_footer1_column_links_links
  pages_blocks_footer1_column_links: typeof pages_blocks_footer1_column_links
  pages_blocks_footer1_footer_links: typeof pages_blocks_footer1_footer_links
  pages_blocks_footer1: typeof pages_blocks_footer1
  ...
  pages_blocks_multi_form1: typeof pages_blocks_multi_form1
  sub_links: typeof sub_links
  nav_links: typeof nav_links
  btns: typeof btns
  pages_blocks_navbar1: typeof pages_blocks_navbar1
  cat_link_items_5: typeof cat_link_items_5
  cat_links_5: typeof cat_links_5
  featured_links_5: typeof featured_links_5
  nav_links_5: typeof nav_links_5
  btns_5: typeof btns_5
  pages_blocks_navbar5: typeof pages_blocks_navbar5
  pages: typeof pages
  pages_rels: typeof pages_rels
  _pages_v_version_hero_links: typeof _pages_v_version_hero_links
  _pages_v_blocks_banner1: typeof _pages_v_blocks_banner1
  ...
  _pages_v_blocks_footer1_column_links_links: typeof _pages_v_blocks_footer1_column_links_links
  _pages_v_blocks_footer1_column_links: typeof _pages_v_blocks_footer1_column_links
  _pages_v_blocks_footer1_footer_links: typeof _pages_v_blocks_footer1_footer_links
  _pages_v_blocks_footer1: typeof _pages_v_blocks_footer1
  ...
  _pages_v_blocks_multi_form1: typeof _pages_v_blocks_multi_form1
  _sub_links_v: typeof _sub_links_v
  _nav_links_v: typeof _nav_links_v
  _btns_v: typeof _btns_v
  _pages_v_blocks_navbar1: typeof _pages_v_blocks_navbar1
  _cat_link_items_5_v: typeof _cat_link_items_5_v
  _cat_links_5_v: typeof _cat_links_5_v
  _featured_links_5_v: typeof _featured_links_5_v
  _nav_links_5_v: typeof _nav_links_5_v
  _btns_5_v: typeof _btns_5_v
  _pages_v_blocks_navbar5: typeof _pages_v_blocks_navbar5
  ...
  relations_pages_blocks_banner1: typeof relations_pages_blocks_banner1
  ...
  relations_pages_blocks_footer1_column_links_links: typeof relations_pages_blocks_footer1_column_links_links
  relations_pages_blocks_footer1_column_links: typeof relations_pages_blocks_footer1_column_links
  relations_pages_blocks_footer1_footer_links: typeof relations_pages_blocks_footer1_footer_links
  relations_pages_blocks_footer1: typeof relations_pages_blocks_footer1
  ...
  relations_pages_blocks_multi_form1: typeof relations_pages_blocks_multi_form1
  relations_sub_links: typeof relations_sub_links
  relations_nav_links: typeof relations_nav_links
  relations_btns: typeof relations_btns
  relations_pages_blocks_navbar1: typeof relations_pages_blocks_navbar1
  relations_cat_link_items_5: typeof relations_cat_link_items_5
  relations_cat_links_5: typeof relations_cat_links_5
  relations_featured_links_5: typeof relations_featured_links_5
  relations_nav_links_5: typeof relations_nav_links_5
  relations_btns_5: typeof relations_btns_5
  relations_pages_blocks_navbar5: typeof relations_pages_blocks_navbar5
  ...
  relations__pages_v_blocks_banner1: typeof relations__pages_v_blocks_banner1
  ...
  relations__pages_v_blocks_footer1_column_links_links: typeof relations__pages_v_blocks_footer1_column_links_links
  relations__pages_v_blocks_footer1_column_links: typeof relations__pages_v_blocks_footer1_column_links
  relations__pages_v_blocks_footer1_footer_links: typeof relations__pages_v_blocks_footer1_footer_links
  relations__pages_v_blocks_footer1: typeof relations__pages_v_blocks_footer1
  ...
  relations__pages_v_blocks_multi_form1: typeof relations__pages_v_blocks_multi_form1
  relations__sub_links_v: typeof relations__sub_links_v
  relations__nav_links_v: typeof relations__nav_links_v
  relations__btns_v: typeof relations__btns_v
  relations__pages_v_blocks_navbar1: typeof relations__pages_v_blocks_navbar1
  relations__cat_link_items_5_v: typeof relations__cat_link_items_5_v
  relations__cat_links_5_v: typeof relations__cat_links_5_v
  relations__featured_links_5_v: typeof relations__featured_links_5_v
  relations__nav_links_5_v: typeof relations__nav_links_5_v
  relations__btns_5_v: typeof relations__btns_5_v
  relations__pages_v_blocks_navbar5: typeof relations__pages_v_blocks_navbar5
